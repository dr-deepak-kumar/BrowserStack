...
public class BStackDemoTest extends SeleniumTest {
    ...
    public void addProductToCart1() throws Exception {
        ...
        // Save the text of the product for later verify
        String productOnScreenText = driver.findElement(By.xpath("//*[@id=\"2\"]/p")).getText();
        // Click on add to cart button
        ...
        // Check the product inside the cart is same as of the main page
        String productOnCartText = driver.findElement(By.xpath("//*[@id=\"__next\"]/div/div/div[2]/div[2]/div[2]/div/div[3]/p[2]")).getText();
        Assert.assertEquals(productOnScreenText, productOnCartText);
    }
